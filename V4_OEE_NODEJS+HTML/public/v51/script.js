...
btn_start_producao.addEventListener('click', () => enviarComando_producao('start'));
btn_pause_producao.addEventListener('click', () => enviarComando_producao('pause'));
btn_cancel_producao.addEventListener('click', () => enviarComando_producao('cancel'));
